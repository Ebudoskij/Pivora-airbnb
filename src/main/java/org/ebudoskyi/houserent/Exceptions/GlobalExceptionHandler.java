...
public class GlobalExceptionHandler {
    @ExceptionHandler({UserNotFoundException.class, PropertyNotFoundException.class, BookingNotFoundException.class})
    ...
    public String handleSearchDateException(SearchDateException e, Model model) {
    ...
    @ExceptionHandler({BookingDateException.class, AlreadyBookedException.class})
    public String handleBookingDateException(BookingDateException e, Model model) {
        model.addAttribute("error", e.getMessage());
